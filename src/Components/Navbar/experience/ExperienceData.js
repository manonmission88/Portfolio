export const experiences = {
    employment: [
        ...
        },
        {
            ...
            role: "Teaching Assistant, Washington, DC",
            date: "Oct 2024 - Dec 2024",
            details: [
                "Assisted with grading assignments and providing feedback to students in the Explore to Computer Science (CSCI 120) course.",
                "Collaborated with faculty to  develop course materials to enhance the student learning experience.",
                "Assisted students in exploring the field of computer science and identifying potential career opportunities."
            ]
        }
    ],
    research: [
        ...
        },
        {
            ...
            details: [
                "Tested the YALE datasets of around 100k images and used it for facial and ear recognition using Python.",
                "Achieved a 90% accuracy rate for facial recognition algorithms and 75% for ear recognition algorithms by testing and refining them with editing software like Adobe Photoshop to add occlusions, adjust lighting, and enhance image quality."
            ]
        }
    ]
};
